...
export const toolsByCategory = {
  image: [
    ...
    },
    {
      ...
      seoContent: {
        h1: "Image to SVG",
        intro: "Turn raster images like PNG and JPEG into scalable vector graphics.",
        howToUse: ["Upload a raster image.", "Adjust tracing parameters if available.", "Download the SVG."],
        features: ["Automatic vectorization", "Editable output", "Supports common input formats"],
        benefits: ["Infinite scaling without quality loss", "Smaller vector files for simple graphics", "Easy editing in vector software"],
        useCases: ["Logo digitization", "Converting sketches", "Creating cut files"],
        faqs: [
          { question: "Does it work for photographs?", answer: "It can produce stylized vector results; photographs may look posterized." },
          { question: "What tracing options are available?", answer: "Basic controls like threshold and smoothing are provided." },
        ],
