        ...
        <section className={styles["compliance-section"]}>
          ...
          <div className={styles["compliance-grid"]}>
            {compliance.map((item, index) => (
              <div key={index} className={styles["compliance-card"]}>
                <div className={styles["compliance-header"]}>
                  <h3>{item.standard}</h3>
                  <span className={styles["compliance-status"]}>{item.status}</span>
                </div>
        ...
        <section className={styles["security-practices"]}>
          ...
          <div className={styles["practices-grid"]}>
            {securityPractices.map((practice, index) => (
              <div key={index} className={styles["practice-card"]}>
                <h3>{practice.area}</h3>
                <ul>
        ...
        <section className={styles["security-contact"]}>
          <div className={styles["contact-content"]}>
            ...
            <div className={styles["contact-actions"]}>
              <a href="mailto:security@easemytools.com" className={styles["contact-button"]}>
                {"Contact Security Team"}
              </a>
              <a href="/privacy-policy" className={`${styles["contact-button"]} ${styles["secondary"]}`}>
                {"View Privacy Policy"}
              </a>
            </div>
          </div>
