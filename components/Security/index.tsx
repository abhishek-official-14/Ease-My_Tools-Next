...
const Security = () => {
    const securityFeatures = [
        ...
        },
        {
            ...
            description:
                "We do not store, upload, or permanently save any files you process through our tools.",
        },
        {
            icon: "🔐",
    ...
    const compliance = [
        ...
        },
        {
            standard: "FERPA",
            description:
                "Family Educational Rights and Privacy Act for education",
            status: "Compliant",
        },
    ]
    ...
    return (
        <div className={styles["security-page"]}>
            <div className={styles["security-container"]}>
                ...
                <section className={styles["security-features"]}>
                ...
                <section className={styles["compliance-section"]}>
                    ...
                    <div className={styles["compliance-grid"]}>
                        {compliance.map((item, index) => (
                            <div
                                key={index}
                                className={styles["compliance-card"]}
                            >
                                <div className={styles["compliance-header"]}>
                                    <h3>{item.standard}</h3>
                                    <span
                                        className={styles["compliance-status"]}
                                    >
                                        {item.status}
                                    </span>
                                </div>
                ...
                <section className={styles["security-practices"]}>
                    <h2>{"Security Practices"}</h2>
                    <div className={styles["practices-grid"]}>
                        {securityPractices.map((practice, index) => (
                            <div
                                key={index}
                                className={styles["practice-card"]}
                            >
                                <h3>{practice.area}</h3>
                                <ul>
                                    {practice.practices.map(
                                        (item, itemIndex) => (
                ...
                <section className={styles["security-faq"]}>
                    <h2>{"Security FAQs"}</h2>
                    <div className={styles["faq-grid"]}>
                        <div className={styles["faq-item"]}>
                            ...
                            <p>
                                {
                                    "All file processing happens locally in your web browser. Your files never leave your device and are never transmitted to our servers."
                                }
                            </p>
                        </div>
                        <div className={styles["faq-item"]}>
                            ...
                            <p>
                                {
                                    "No. We do not store, upload, or permanently save any files you process. Temporary data is automatically cleared when you close your browser."
                                }
                            </p>
                        </div>
                        <div className={styles["faq-item"]}>
                            ...
                            <p>
                                {
                                    "We only collect essential information for service operation, such as anonymous usage statistics and error reports. No personal file data is collected."
                                }
                            </p>
                        </div>
                        <div className={styles["faq-item"]}>
                            ...
                            <p>
                                {
                                    "We undergo regular third-party security audits and maintain comprehensive documentation of our security practices and compliance measures."
                                }
                            </p>
                        </div>
                    </div>
                ...
                <section className={styles["security-contact"]}>
                    <div className={styles["contact-content"]}>
                        ...
                        <div className={styles["contact-actions"]}>
                            <a
                                href="mailto:security@easemytools.com"
                            ...
                            <a
                                href="/privacy-policy"
                                className={`${styles["contact-button"]} ${styles["secondary"]}`}
                            >
                                {"View Privacy Policy"}
                            </a>
                        </div>
