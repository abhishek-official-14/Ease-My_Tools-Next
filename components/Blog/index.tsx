...
const categories = [
    ...
    {
        name: "Productivity",
        count: blogPosts.filter((post) => post.category === "Productivity")
            .length,
    },
    {
        name: "Technology",
        count: blogPosts.filter((post) => post.category === "Technology")
            .length,
    },
    {
        name: "Security",
            ...
            <div className={styles["blog-container"]}>
                <header className={styles["blog-header"]}>
                    ...
                    <p className={styles["blog-subtitle"]}>
                        Tips, tutorials, and insights to help you get the most
                        out of our tools
                    </p>
                    <p className={styles["author-meta"]}>
                        By {BLOG_AUTHOR.name} · {BLOG_AUTHOR.role}
                    </p>
                </header>
                ...
                <div className={styles["blog-layout"]}>
                    <main className={styles["blog-content"]}>
                        <section
                            className={styles["featured-posts"]}
                        ...
                        >
                            ...
                            <div className={styles["posts-grid"]}>
                                {blogPosts.map((post) => (
                                    <article
                                        key={post.id}
                                        className={`${styles["post-card"]} ${styles["featured"]}`}
                                    >
