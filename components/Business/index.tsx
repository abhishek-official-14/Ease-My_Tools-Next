            ...
            <div className={styles["business-container"]}>
                <header className={styles["business-header"]}>
                    <div className={styles["header-content"]}>
                        ...
                        <p className={styles["subtitle"]}>
                            Free online tools to simplify everyday digital
                            tasks. No registration required — just choose a tool
                ...
                <section className={styles["business-cta"]}>
                    <div className={styles["cta-content"]}>
                        ...
                        <p>
                            Discover a growing collection of tools designed to
                            save time, boost productivity, and make your work
                            easier.
                        </p>
