                    ...
                    <div className="flex flex-wrap items-center justify-between gap-1 border-b-2 border-slate-300/90 bg-slate-100/50 px-2 py-2 shadow-sm backdrop-blur-sm sm:gap-2 sm:px-5 sm:py-3 dark:border-slate-600/80 dark:bg-slate-800/40 dark:shadow-black/10">
                        <div className="flex flex-wrap items-center gap-0.5 sm:gap-2">
                            <button
                                ...
                                className="rounded-lg p-1 text-lg text-slate-600 transition hover:bg-slate-100 sm:p-2 sm:text-base dark:text-slate-300 dark:hover:bg-slate-800"
                            ...
                            <button
                                ...
                                className="rounded-lg px-1.5 py-0.5 text-lg font-semibold text-slate-700 hover:bg-slate-100 sm:px-3 sm:py-1.5 sm:text-sm dark:text-slate-300 dark:hover:bg-slate-800"
                            ...
                            <button
                                ...
                                className="rounded-lg px-1.5 py-0.5 text-lg text-slate-700 hover:bg-slate-100 sm:px-3 sm:py-1.5 sm:text-base dark:text-slate-300 dark:hover:bg-slate-800"
                                title="Link (Ctrl+K)"
                            >
                                🔗
                            </button>
                            ...
                            <button
                                ...
                                className="rounded-lg px-1.5 py-0.5 font-mono text-lg text-slate-700 hover:bg-slate-100 sm:px-3 sm:py-1.5 sm:text-base dark:text-slate-300 dark:hover:bg-slate-800"
                                title="Code block"
                            >
                                &lt;/&gt;
                            </button>
                        ...
                        <div className="flex flex-wrap items-center gap-1 sm:gap-3">
                            <span
                                className="text-lg text-slate-500 sm:text-lg dark:text-slate-400"
                                title="Word Count"
                            >
                                📊 {wordCount} words
                            </span>
                            ...
                            <button
                                ...
                                className="rounded-lg px-3 py-1.5 text-lg text-slate-700 hover:bg-slate-100 sm:px-4 sm:py-1.5 sm:text-lg dark:text-slate-300 dark:hover:bg-slate-800"
                                title="Copy"
                            >
                                {isCopied ? "✓" : "⎘"}
                            </button>
                            <button
                                ...
                                className="rounded-lg px-3 py-1.5 text-lg text-emerald-600 hover:bg-emerald-100 sm:px-4 sm:py-1.5 sm:text-lg dark:text-emerald-400 dark:hover:bg-emerald-900/40"
                                title="Download"
                            >
                                ↓
                            </button>
                            ...
                            <button
                                ...
                                className="rounded-lg px-3 py-1.5 text-lg text-rose-600 hover:bg-rose-50 sm:px-4 sm:py-1.5 sm:text-lg dark:text-rose-400 dark:hover:bg-rose-950/20"
                                title="Clear"
                            >
                                ✕
                            </button>
