    ...
    const features = [
        {
            ...
            description:
                "Lightning-fast performance with native desktop optimization",
        },
        {
            icon: "💾",
            ...
            <div className={styles["desktop-container"]}>
                    ...
                    <div className={styles["header-content"]}>
                        ...
                        <div className={styles["download-badges"]}>
                            {downloadOptions.map((option, index) => (
                                ...
                                >
                                    <span className={styles["os-icon"]}>
                                        {option.icon}
                                    </span>
                                    <div className={styles["os-info"]}>
                                        <span className={styles["os-name"]}>
                                            {option.os}
                                        </span>
                                        <span className={styles["os-details"]}>
                ...
                <section className={styles["desktop-cta"]}>
                    <div className={styles["cta-content"]}>
                        ...
                        <p>
                            {
                                "Download the desktop app and experience the full power of EaseMyTools"
                            }
                        </p>
