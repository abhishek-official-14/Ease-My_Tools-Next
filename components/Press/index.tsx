    ...
    const pressReleases = [
        {
            ...
            date: "2024-01-15",
            excerpt:
                "New feature allows users to remove image backgrounds with unprecedented accuracy and speed, completely free.",
        ...
        },
        {
            ...
            date: "2024-01-10",
            excerpt:
                "Platform celebrates rapid growth and user adoption across 150+ countries worldwide.",
            category: "Milestone",
        },
        {
            id: 3,
            ...
            date: "2024-01-05",
            excerpt:
                "Funding round led by Tech Ventures to accelerate product development and global expansion.",
            category: "Funding",
        },
    ]
                    ...
                    <div className={styles["contact-card"]}>
                        ...
                        <div className={styles["contact-info"]}>
                            <div className={styles["contact-item"]}>
                                <strong>{"Email:"}</strong>
                                <a href="mailto:press@easemytools.com">
                                    press@easemytools.com
                                </a>
                            </div>
                            <div className={styles["contact-item"]}>
                                <strong>{"Phone:"}</strong>
                        ...
                        {pressReleases.map((release) => (
                            ...
                            >
                                <div className={styles["release-meta"]}>
                                    ...
                                    <span
                                        className={styles["release-category"]}
                                    >
                                        {release.category}
                                    </span>
                                </div>
                                <h3 className={styles["release-title"]}>
                                    {release.title}
                                </h3>
                                <p className={styles["release-excerpt"]}>
                                    {release.excerpt}
                                </p>
                                <a
                                    href="#"
                ...
                <section className={styles["media-coverage"]}>
                    ...
                    <div className={styles["coverage-grid"]}>
                        {mediaCoverage.map((coverage, index) => (
                            <article
                                key={index}
                                className={styles["coverage-card"]}
                            >
                                <div className={styles["coverage-header"]}>
                                    <div className={styles["outlet-logo"]}>
                                        {coverage.logo}
                                    </div>
                                    <div className={styles["outlet-info"]}>
                                        <h3 className={styles["outlet-name"]}>
                                            {coverage.outlet}
                                        </h3>
                                        <span
                                            className={styles["coverage-date"]}
                                        >
                                            {coverage.date}
                                        </span>
                                    </div>
                                ...
                                <a
                                    href={coverage.link}
                                    className={styles["read-article"]}
                                    aria-label={`Read article from ${coverage.outlet}: ${coverage.title}`}
                                    target="_blank"
                        ...
                        {pressKit.map((item, index) => (
                            <div key={index} className={styles["kit-item"]}>
                                <div className={styles["kit-info"]}>
                                    ...
                                    <span className={styles["kit-format"]}>
                                        {item.format}
                                    </span>
                                </div>
                                <a
                ...
                <section className={styles["company-info"]}>
                    ...
                    <div className={styles["info-grid"]}>
                        <div className={styles["info-card"]}>
                            ...
                            <p>
                                {
                                    "EaseMyTools is a comprehensive suite of free online tools that help users with file conversion, image editing, text processing, and data analysis. All processing happens locally in the browser, ensuring maximum privacy and security."
                                }
                            </p>
                        </div>
                        <div className={styles["info-card"]}>
                            ...
                            <ul>
                                ...
                                <li>
                                    {
                                        "Users: Usage metrics are not publicly disclosed"
                                    }
                                </li>
                                <li>{"Tools: 50+ and growing"}</li>
                                <li>
                                    {"Team: Team details available on request"}
                                </li>
                            </ul>
                        </div>
                    </div>
