...
export default function SvgConverter() {
    ...
    const handleFileUpload = useCallback((uploadedFile: File | null | undefined) => {
        ...
        try {
            ...
            img.onload = () => {
                ...
                if (conversionSettings.backgroundColor !== "transparent") {
                    ...
                    if (bgColor === "custom") bgColor = conversionSettings.customBackground;
                    ...
                    <div className="grid gap-6 px-4 py-4 sm:px-6 sm:py-5 lg:grid-cols-[1fr_1.1fr]">
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center justify-center">
                                        ...
                                        <div className="mt-3 flex flex-wrap justify-center gap-1.5">
                                            <span className="rounded-full bg-slate-100 px-2.5 py-0.5 text-[10px] font-medium text-slate-500 dark:bg-slate-800 dark:text-slate-400">SVG</span>
                                        </div>
                                ...
                                <>
                                        ...
                                        <div className="grid grid-cols-3 gap-2">
                                            {formatOptions.map(({ key, label }) => (
                                                <button
                                                    key={key}
                                                    onClick={() =>
                                                        setConversionSettings((prev) => ({ ...prev, format: key }))
                                                    }
                                                    className={`rounded-lg border px-2 py-1.5 text-xs font-semibold transition-all duration-200 ${conversionSettings.format === key
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-4 gap-2">
                                            {bgOptions.map(({ key, label }) => (
                                                <button
                                                    key={key}
                                                    onClick={() =>
                                                        setConversionSettings((prev) => ({ ...prev, backgroundColor: key }))
                                                    }
                                                    className={`rounded-lg border px-2 py-1.5 text-xs font-semibold transition-all duration-200 ${conversionSettings.backgroundColor === key
                                                            ? "border-blue-500 bg-blue-500 text-white shadow-sm shadow-blue-500/20"
                                                            : "border-slate-200 bg-white/60 text-slate-700 hover:border-slate-300 hover:bg-slate-100 dark:border-slate-800 dark:bg-slate-800/40 dark:text-slate-200 dark:hover:border-slate-700 dark:hover:bg-slate-800"
                                                        }`}
                                                >
                                        ...
                                        {conversionSettings.backgroundColor === "custom" && (
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    setConversionSettings((prev) => ({ ...prev, customBackground: e.target.value }))
                                                }
                                    ...
                                    {conversionSettings.format !== "png" && (
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    setConversionSettings((prev) => ({ ...prev, quality: parseInt(e.target.value) }))
                                                }
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setConversionSettings((prev) => ({ ...prev, maintainAspectRatio: e.target.checked }))
                                            }
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            <div>
                                                <label className="mb-1 block text-xs text-slate-500 dark:text-slate-400">Height</label>
                                                <input
                                                    type="number"
                                    ...
                                    <div className="flex gap-3 pt-2">
                                        <button
                                            ...
                                            disabled={converting}
                                            className={`flex-1 rounded-lg px-3 py-2 text-xs font-bold tracking-wide text-white transition-all active:scale-[0.98] ${converting
                        ...
                        <div className="space-y-5">
                            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div className="flex min-h-[200px] items-center justify-center rounded-lg border border-slate-200/80 bg-white/60 p-4 dark:border-slate-800/60 dark:bg-slate-800/30">
                                        {originalSvg ? (
                                            ...
                                            <div className="hidden lg:block text-center opacity-60">
                                                ...
                                                <p className="text-xs text-slate-500 dark:text-slate-400">SVG preview</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div>
                                    <h3 className="mb-2 text-xs font-semibold tracking-wider text-slate-500 uppercase dark:text-slate-400">
                                        Converted ({conversionSettings.format.toUpperCase()})
                                    </h3>
                                    <div className="flex min-h-[200px] items-center justify-center rounded-lg border border-slate-200/80 bg-white/60 p-4 dark:border-slate-800/60 dark:bg-slate-800/30">
                                        {convertedImage ? (
                                            <img src={convertedImage} alt="Converted" className="max-h-48 object-contain" />
                                        ) : (
                                            <div className="hidden lg:block text-center opacity-60">
                                                <div className="mb-2 text-5xl">✨</div>
                                                <p className="text-xs text-slate-500 dark:text-slate-400">Converted image will appear here</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                            ...
                            {convertedImage && (
                                ...
                                >
                                    Download {conversionSettings.format.toUpperCase()}
                                </button>
                            )}
                        </div>
                    </div>
