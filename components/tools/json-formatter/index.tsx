                ...
                <div className="overflow-hidden rounded-xl border border-slate-200/80 bg-white/80 shadow-xl shadow-slate-200/40 backdrop-blur-sm dark:border-slate-800/60 dark:bg-slate-900/80 dark:shadow-black/30">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-1 border-b-2 border-slate-300/90 bg-slate-100/50 px-2 py-2 shadow-sm backdrop-blur-sm dark:border-slate-600/80 dark:bg-slate-800/40 dark:shadow-black/10 sm:gap-2 sm:px-5 sm:py-3">
                        <div className="flex flex-wrap items-center gap-0.5 sm:gap-2">
                            <button
                                onClick={formatJson}
                                className="rounded-lg px-2 py-1 text-xs font-semibold text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800 sm:px-3 sm:py-1.5 sm:text-sm"
                            ...
                            <button
                                ...
                                className="rounded-lg px-2 py-1 text-xs font-semibold text-emerald-600 hover:bg-emerald-50 dark:text-emerald-400 dark:hover:bg-emerald-900/40 sm:px-3 sm:py-1.5 sm:text-sm"
                            ...
                            <div className="flex items-center gap-1 text-xs">
                                ...
                                {indentOptions.map((spaces) => (
                                    <button
                                        ...
                                        className={`rounded px-1.5 py-0.5 text-xs font-mono ${formatIndent === spaces
                        ...
                        <div className="flex flex-wrap items-center gap-1 sm:gap-3">
                            ...
                            <button
                                onClick={copyOutput}
                                disabled={!output}
                                className="flex items-center gap-1 rounded-lg px-2 py-1 text-slate-700 hover:bg-slate-100 disabled:opacity-40 dark:text-slate-300 dark:hover:bg-slate-800 sm:px-3 sm:py-1.5"
                                title="Copy output"
                            >
                                <span className="text-base sm:text-lg">⎘</span>
                                <span className="text-[11px] sm:text-xs font-medium">Copy</span>
                            </button>
                            {/* Clear button - larger icon, smaller text */}
                            <button
                                onClick={clearAll}
                                className="flex items-center gap-1 rounded-lg px-2 py-1 text-rose-600 hover:bg-rose-50 dark:text-rose-400 dark:hover:bg-rose-950/20 sm:px-3 sm:py-1.5"
                                title="Clear all"
                            >
                                <span className="text-base sm:text-lg">✕</span>
                                <span className="text-[11px] sm:text-xs font-medium">Clear</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex border-b border-slate-200/80 lg:hidden dark:border-slate-800/60">
                        <button
                            ...
                            className={`flex-1 py-3 text-center text-sm font-medium transition ${activeTab === "editor"
                        ...
                        <button
                            ...
                            className={`flex-1 py-3 text-center text-sm font-medium transition ${activeTab === "output"
                                    ? "border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                                    : "text-slate-500 dark:text-slate-400"
                                }`}
                        >
                    ...
                    <div className="grid gap-5 p-4 sm:p-6 lg:grid-cols-2">
                        ...
                        <div className={`${activeTab === "output" ? "hidden lg:block" : ""}`}>
                            <div className="rounded-xl border border-slate-300 dark:border-slate-700 h-[480px] flex flex-col">
                                ...
                                <div className="border-b border-slate-200 bg-slate-100/80 px-5 py-3 dark:border-slate-700 dark:bg-slate-800/50 flex-shrink-0">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {isValid !== null && (
                                                <span
                                                    className={`text-xs font-mono px-2 py-0.5 rounded-full ${isValid
                                    ...
                                    <div className="p-5">
                                        {error && (
                                            <div className="mb-3 rounded-lg border border-rose-200 bg-rose-50/80 px-3 py-2 text-xs text-rose-700 dark:border-rose-900/40 dark:bg-rose-950/20 dark:text-rose-200">
                                                <span className="font-mono">Parse error: {error}</span>
                                            </div>
                                        )}
                                        {output ? (
                                            <pre className="font-mono text-sm whitespace-pre-wrap break-words text-slate-800 dark:text-slate-200">
                                                {output}
                                            </pre>
                                        ) : (
                                            <div className="text-center text-slate-400 dark:text-slate-500 text-sm py-10">
                                                No output yet. Click Format or Minify.
                                            </div>
                                        )}
                                    </div>
                                </div>
